<?php
	...
	if (isset($_POST['checklist'])) {
		$sqlCommand = "INSERT INTO `program_check_detail`(`checklist_id`, `checklist_name_th`, `checklist_name_en`, `checklist_name_tag`, `date_modify`, `user`) VALUES (NULL,'$_POST[cl_name]','$_POST[cl_name_en]','$_POST[cl_name_tag]','$_SESSION[date]','$_SESSION[user_name]')";
		$result=mysqli_query($con,$sqlCommand)
			or die("Failed db".mysqli_error());
